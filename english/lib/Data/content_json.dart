List<Map<String, dynamic>> contentJSON = [
  {
    ...
    "array": [
      ...
      {"trans": "держать пари", "form1": "bet", "form2": "bet", "form3": "bet"},
      {
      ...
      {"trans": "закрывать", "form1": "shut", "form2": "shut", "form3": "shut"},
      {"trans": "покидать", "form1": "quit", "form2": "quit", "form3": "quit"},
      {"trans": "избавлять", "form1": "rid", "form2": "rid", "form3": "rid"},
      {"trans": "проливать", "form1": "shed", "form2": "shed", "form3": "shed"},
      {
        "trans": "разразиться",
        "form1": "burst",
        "form2": "burst",
  ...
  },
  {
    ...
    "array": [
      ...
      {"trans": "купить", "form1": "buy", "form2": "bought", "form3": "bought"},
      ...
      {"trans": "продавать", "form1": "sell", "form2": "sold", "form3": "sold"},
      ...
      {"trans": "ускорять", "form1": "speed", "form2": "sped", "form3": "sped"},
      {
        "trans": "подразумевать",
        "form1": "mean",
        "form2": "meant",
      ...
      {"trans": "оставить", "form1": "leave", "form2": "left", "form3": "left"},
      ...
      {"trans": "слышать", "form1": "hear", "form2": "heard", "form3": "heard"},
      {"trans": "стоять", "form1": "stand", "form2": "stood", "form3": "stood"},
      {
        "trans": "грезить",
        "form1": "dream",
        "form2": "dreamt",
      ...
      {"trans": "спать", "form1": "sleep", "form2": "slept", "form3": "slept"},
      {
        "trans": "тратить",
        "form1": "spend",
        "form2": "spent",
      ...
      {"trans": "стрелять", "form1": "shoot", "form2": "shot", "form3": "shot"},
      {"trans": "крутиться", "form1": "spin", "form2": "spun", "form3": "spun"},
      ...
      {"trans": "связать", "form1": "bind", "form2": "bound", "form3": "bound"},
      {
        "trans": "пахнуть",
        "form1": "smell",
        "form2": "smelt",
      ...
      {"trans": "прыгать", "form1": "leap", "form2": "leapt", "form3": "leapt"},
      {
        "trans": "пролить",
        "form1": "spill",
        "form2": "spilt",
      ...
      {"trans": "мести", "form1": "sweep", "form2": "swept", "form3": "swept"},
      {"trans": "одолжить", "form1": "lend", "form2": "lent", "form3": "lent"},
      {
        "trans": "ужалить",
        "form1": "sting",
        "form2": "stung",
      ...
      {"trans": "ползти", "form1": "creep", "form2": "crept", "form3": "crept"},
      ...
      {"trans": "раздирать", "form1": "rend", "form2": "rent", "form3": "rent"},
      {
  ...
  },
  {
    ...
    "array": [
      ...
      {"trans": "гнать", "form1": "drive", "form2": "drove", "form3": "driven"},
      {
        "trans": "выбрать",
        "form1": "choose",
        "form2": "chose",
      ...
      {"trans": "падать", "form1": "fall", "form2": "fell", "form3": "fallen"},
      {
        "trans": "(с)ломать",
        "form1": "break",
        "form2": "broke",
  ...
  },
  {
    ...
    "array": [
      ...
      {"trans": "начать", "form1": "begin", "form2": "began", "form3": "begun"},
      ...
      {"trans": "вонять", "form1": "stink", "form2": "stank", "form3": "stunk"}
    ]
  }
];
